...
import { BigintIsh, Currency, CurrencyAmount, TradeType } from '@yumyumswap/sdk-core'
import { encodeRouteToPath, MethodParameters, toHex } from './utils'
import IQuoter from '@yumyumswap/contract-periphery/artifacts/contracts/lens/Quoter.sol/Quoter.json'
import IQuoterV2 from '@yumyumswap/swap-router-contracts/artifacts/contracts/lens/QuoterV2.sol/QuoterV2.json'
...
/**
 * Represents the YumYumSwap QuoterV1 contract with a method for returning the formatted
