import { BigintIsh, Token } from '@yumyumswap/sdk-core'
import { Interface } from '@ethersproject/abi'
import ISelfPermit from '@yumyumswap/contract-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json'
