...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@yumyumswap/sdk-core'
...
import ISwapRouter from '@yumyumswap/contract-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
...
/**
 * Represents the YumYumSwap SwapRouter, and has static methods for helping execute trades.
 */
