...
import INonfungiblePositionManager from '@yumyumswap/contract-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json'
