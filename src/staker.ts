...
import IYumyumSwapStaker from '@uniswap/v3-staker/artifacts/contracts/YumyumSwapStaker.sol/YumyumSwapStaker.json'
...
export abstract class Staker {
  public static INTERFACE: Interface = new Interface(IYumyumSwapStaker.abi)
